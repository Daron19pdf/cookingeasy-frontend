...
useEffect(() => { 
  fetch('http://192.168.1.15:3000/user/user/?token=FRtMxr4qfwowrV26PEGkbS5qNJcKK6Xq')
.then((response) => response.json())
.then((data) => {
  console.log(data.data.preference._id);
  fetch(`http://192.168.1.15:3000/menu/recettes?userId=${data.data.preference._id}`)
   .then((response) => response.json())
    .then((data) => { 
      console.log(data);
