import {
  ...
  export default function Index ({ navigation}) {
    return (
        ...
        <TouchableOpacity style={styles.next} onPress={() => navigation.navigate('EquipementScreen')}>
          <Text style={styles.buttonText}>Equipement Screen</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.next} onPress={() => navigation.navigate('BienvenueScreen')}>
          <Text style={styles.buttonText}>Bienvenue Screen</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.next} onPress={() => navigation.navigate('RegimeScreen')}>
          <Text style={styles.buttonText}>RegimeScreen</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.next} onPress={() => navigation.navigate('ConservationScreen')}>
          <Text style={styles.buttonText}>ConservationScreen</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.next} onPress={() => navigation.navigate('FavorisScreen')}>
          <Text style={styles.buttonText}>FavorisScreen</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.next} onPress={() => navigation.navigate('FelicitationsScreen')}>
          <Text style={styles.buttonText}>FelicitationsScreen</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.next} onPress={() => navigation.navigate('InfoScreen')}>
          <Text style={styles.buttonText}>InfoScreen</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.next} onPress={() => navigation.navigate('InscriptionScreen')}>
        ...
        <TouchableOpacity style={styles.next} onPress={() => navigation.navigate('PrefSemaineScreen')}>
          <Text style={styles.buttonText}>PrefSemaineScreen</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.next} onPress={() => navigation.navigate('ProfilScreen')}>
