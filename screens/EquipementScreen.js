    ...
    <View style={styles.container}>
      ...
      <View style={styles.equipement}>
        ...
        <TouchableOpacity onPress={() => setIsFourClicked(!isFourClicked)}>
          <Image style={[styles.four, isFourClicked && styles.fourClicked]} source={require("../assets/four.png")} />
          <Text style={styles.appareil}>four</Text>
        </TouchableOpacity>

        <TouchableOpacity onPress={() => setIsFriteuseClicked(!isFriteuseClicked)}>
          <Image style={[styles.friteuse, isFriteuseClicked && styles.friteuseClicked]} source={require("../assets/friteuse.png")} />
          <Text style={styles.appareil}>friteuse</Text>
        </TouchableOpacity>

        <TouchableOpacity onPress={() => setIsMicroOndesClicked(!isMicroOndesClicked)}>
          <Image style={[styles.microOndes, isMicroOndesClicked && styles.microOndesClicked]} source={require("../assets/micro-ondes.png")} />
          <Text style={styles.appareil}>micro-ondes</Text>
        </TouchableOpacity>

        <TouchableOpacity onPress={() => setIsMixeurClicked(!isMixeurClicked)}>
          <Image style={[styles.mixeur, isMixeurClicked && styles.MixeurClicked]} source={require("../assets/mixeur.png")} />
          <Text style={styles.appareil}>mixeur</Text>
        </TouchableOpacity>

        <TouchableOpacity onPress={() => setIsPlaqueClicked(!isPlaqueClicked)}>
          <Image style={[styles.plaque, isPlaqueClicked && styles.PlaqueClicked]} source={require("../assets/plaquesCuisson.png")} />
          <Text style={styles.appareil}>plaques de cuisson</Text>
        </TouchableOpacity>

        <TouchableOpacity onPress={() => setIsRobotClicked(!isRobotClicked)}>
          <Image style={[styles.robot, isRobotClicked && styles.RobotClicked]} source={require("../assets/robot.png")} />
...
const styles = StyleSheet.create({
  ...
  fourClicked: { // Ajout du style pour la bordure ombrée
    borderColor: '#E3C7F9',
    borderWidth: 2,
    borderRadius: 10,
    shadowColor: '#E3C7F9',
